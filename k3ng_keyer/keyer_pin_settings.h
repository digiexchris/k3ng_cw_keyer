...
//lcd pins
  ...
  #define lcd_rs 52
  #define lcd_enable 53  // pin 10 is used by Ethernet shield and will conflict with that
  #define lcd_d4 46
  #define lcd_d5 47
  #define lcd_d6 48
  #define lcd_d7 49
...
// rotary encoder pins and options - rotary encoder code from Jim Balls M0CKE
  ...
  #define ptt_interlock A3  // this pin disables PTT and TX KEY
